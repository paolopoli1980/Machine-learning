...
class robot:
    ...
    def moving(self):
        ...
        if (self.x==self.basex2 and self.y==self.basey2 and self.back==0):
            self.counter+=1
            self.back=1            
            self.basex1=np.random.randint(limplayx)
            self.basey1=np.random.randint(limplayy)    

        if (self.x==self.basex1 and self.y==self.basey1 and self.back==1):
            self.counter+=1
            self.back=0                            
            self.basex2=np.random.randint(limplayx)
            self.basey2=np.random.randint(limplayy)                
...
#mat[0]=[[-1.14645707, -3.75467327],
 #[ 3.11061568,  0.85024591],
# [ 3.39574329, -0.49900138],
# [ 3.95134936, -4.66916637],
# [ 1.90318358, -1.15052537],
# [ 0.96977695,  0.72361538],
# [-1.65174339,  2.24944371]]
#mat[1]=[[-2.24482541, -1.84981433],
 #[-4.02117972,  6.14777459]]
################################################################################
#####sigmo matrici 249 1000 steps nn1
#mat[0]=[[-0.76625617, -6.39552146],
# [ 5.25288282, 1.38007866],
# [ 1.98748942,  0.98435777],
 #[ 3.09182904, -4.85872473],
# [ 1.39574056, -1.23403519],
# [ 0.77949871,  0.21478187],
# [-0.73888561,  1.57481223]]

#mat[1]=[[-0.50089717, -0.67274428],
# [-4.24010583,  7.03734582]]
...
# [ 1.90318358, -1.15052537],
# [ 0.96977695,  0.72361538],
# [-1.65174339,  2.24944371],[-1.0, 1.0]]

#mat[1]=[[-2.50089717, -1.67274428],
# [-4.24010583,  7.03734582]]
################
#mat[0]=[[-1.14645707, 3.75467327],
#[ -3.11061568,  0.85024591],
...
#mat[1]=[[-2.50089717, -1.67274428],
# [-4.24010583,  7.03734582]]
mat[0]=[[-2.53373892, -5.83985007],
 [ 5.50184432,  2.35248063],
 [ 0.98402785,  0.88640846],
 [ 3.81277663, -4.06990851],
 [ 2.1857771,  -0.15561515],
 [ 1.05277302,  0.25990394],
 [-0.0253074,   1.71051348]]
mat[1]=[[-0.39334118, -0.12429306],
 [-4.02901882,  7.05034613]]
##################################
memmat[0]=mat[0].copy()
memmat[1]=mat[1].copy()
memmat[2]=mat[2].copy()
