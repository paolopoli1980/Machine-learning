...
nattemps=1200 #######nattemps number of attemps you want to do########
...
#posball=([0,0])
numberofneurons=6
numberofneurons_layer2=4 #in case of a one layer neural network it has to be 4 only preceptors layer =0
numberofinput=6
...
limplayx=120      
limplayy=100
deltamin=-60     #######minimal increment during the back propagation########
deltamax=60 #######maximal increment during the back propagation########
